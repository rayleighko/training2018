...
그 중 퍼포먼스가 뛰어나고, 객체지향을 학습하기에 좋다고 생각하는 C/C++에 대해 애정을 가지고 있고, 현재 가장 활발한 발전을 이루고 있다고 생각되는 Javascript에 매력을 느껴 최근(2018. 12 ~)에는 Javascript를 이용하여 [프로젝트1](https://github.com/teamthesol/boggler), [프로젝트 2](https://github.com/teamthesol/node-DeepSpeech)를 진행하고 있습니다.  

이와는 별개로 [머신러닝 스터디(2018. 06)](https://github.com/rayleighko/ml_study)를 진행하며 공부한 스크립트 언어인 Python에도 애정이 있고, Java는 안정적인 웹 개발을 위해 버릴 수 없는 언어라고 생각하기 때문에 최근(2019. 01 ~)에 다시 관심을 가지고 있습니다.  
...
### 2018. 04. 01 ~ 2018. 11. 21: 강의 공유 플랫폼, Athena v1.0.0(4명) - DevOps(주도), Front-end(일부), Back-end(일부)  
